  ...
  const handleStop = async (blobUrl: string) => {
    ...
    fetch(blobUrl)
      ...
      .then(async (blob) => {
        ...
        await axios
          .post("https://assitant-backend.onrender.com/post-audio", formData, {
            headers: {
      ...
      <div className="flex flex-col justify-between h-full overflow-y-scroll pb-96">
        ...
        <div className="px-5 mt-5">
          ...
          {messages.length == 0 && !isLoading && (
            <div className="mt-10 italic font-light text-center">
              Send Rachel a message...
            </div>
          )}

          {isLoading && (
            <div className="mt-10 italic font-light text-center animate-pulse">
              Gimme a few seconds...
            </div>
          )}
        </div>
